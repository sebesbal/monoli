...
function init_task() {
	...
	renewUsers = function(data){
		task_img = data;
		console.log('loaded');
		console.log('gon.task_txt = ' + gon.task_txt);
		console.log('gon.task_img = ' + task_img);
	...
	gon.watch('task_img', null, renewUsers);
...
function init_task() {
	task_img = gon.task_img;
	console.log('loaded');
	console.log('gon.task_txt = ' + gon.task_txt);
	console.log('gon.task_img = ' + gon.task_img);
	sample_label = $('#sample_label');
	$('#input_field').onkeypress = function(e) {
